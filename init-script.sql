...
--
-- Host: localhost    Database: educativo
-- ------------------------------------------------------
...
CREATE TABLE `cursos_estudiantes` (
  ...
  KEY `fk_cursos` (`codigo_curso`),
  CONSTRAINT `fk_cursos` FOREIGN KEY (`codigo_curso`) REFERENCES `cursos` (`codigo`),
  CONSTRAINT `fk_estudiantes` FOREIGN KEY (`codigo_estudiante`) REFERENCES `estudiantes` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-10 18:47:19